-- ============================================================
-- APPLY MIGRATIONS 039 and 040 to Supabase
-- ============================================================
-- This file combines migrations 039 and 040 for manual application
-- to your Supabase database via the SQL Editor
-- ============================================================

-- ============================================================
-- MIGRATION 039: FIX PAYMENT_TYPE CONSTRAINT
-- ============================================================
...
-- Add new constraint with correct payment types
ALTER TABLE public.material_logs
